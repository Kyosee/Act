@extends('layouts.app')
@section('title', '修改奖品 - 奖品管理 - '.$project->project_name)
@section('head')
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="{{ route('wechat.project.prize.update', [$wechat, $project, $prize]) }}" method="post" accept-charset="UTF-8"
                    enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="chance" id="chance" value="{{ old('chance', $prize->chance) }}" placeholder="请选择中奖概率">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="day_num" class="col-sm-4 control-label">奖品每日发放数量（不限则填0）</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="day_num" id="day_num" value="{{ old('day_num', $prize->day_num) }}" placeholder="请选择奖品每日发放数量（不限则填0）">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="prize_num" class="col-sm-4 control-label">奖品库存量</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="prize_num" id="prize_num" value="{{ old('prize_num', $prize->prize_num) }}" placeholder="请填写奖品库存量">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
